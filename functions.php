...
class P4_Master_Site extends TimberSite {
	...
	public function enqueue_public_assets() {
		...
		wp_enqueue_style( 'parent-style', $this->theme_dir . '/style.css', [], '0.0.7'  );
		wp_register_script( 'jquery-3', 'https://code.jquery.com/jquery-3.2.1.min.js', array(), '3.2.1', true );
		...
		wp_enqueue_script( 'slick', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', array( 'jquery' ), '0.1.0', true );
	}
