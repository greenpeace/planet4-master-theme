    ...
    public function form_fields(): void
    {
        $body_field = new MrkDwnField(
            [
                ...
                'description' => '<a target="_blank" class="external-link" href="https://api.slack.com/reference/surfaces/formatting#basics">Learn about message formatting options</a>', // phpcs:ignore Generic.Files.LineLength.MaxExceeded
                'name' => 'body',
                'resolvable' => true,
                'settings' => [
                    'mode' => 'markdown',
