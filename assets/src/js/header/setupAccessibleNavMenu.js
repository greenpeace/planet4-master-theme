...
export default () => document.addEventListener('DOMContentLoaded', () => {
  ...
  if (mainNav) {
     ...
     */
    const handleNavMenuItem = () => mainNav.querySelectorAll('.nav-item, .nav-donate').forEach(button => {
     ...
     */
    const handleAccessibleNavLink = () => mainNav.querySelectorAll('.accessible-nav-link').forEach(button => {
     ...
     */
    const handleNavMenuSub = () => mainNav.querySelectorAll('.nav-submenu').forEach(submenu => {
     ...
     */
    const handleNavMenuSubItems = () => mainNav.querySelectorAll('.nav-submenu a').forEach(submenuLink => {
