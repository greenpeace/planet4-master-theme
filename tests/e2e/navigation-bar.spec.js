...
test('Test navigation bar menu', async ({page, admin, requestUtils, browserName}) => {
  // To investigate properly after upgrade to WP 7.1
  test.skip(browserName === 'webkit', 'Navigation bar menu test is flaky on WebKit');
