...
const template = ({
  ...
  ['core/group', {className: 'block'}, [
    ...
    ['core/query',
      ...
      getPostListBlockTemplate(__('Daily actions', 'planet4-master-theme')),
    ],
    ['core/spacer', {height: '32px'}],
    ['core/query',
      ACTIONS_LIST_BLOCK_ATTRIBUTES,
      getActionsListBlockTemplate(__('Support a cause', 'planet4-master-theme')),
    ],
    ...
    ['core/group', {
      ...
      ['core/group', {className: 'container'}, [
        ['core/query',
          POSTS_LIST_BLOCK_ATTRIBUTES,
          getPostListBlockTemplate(__('Take action with us', 'planet4-master-theme')),
        ],
        ['core/spacer', {height: '32px'}],
        ['planet4-block-templates/deep-dive', {
          title: __('Raise awareness in your community', 'planet4-master-theme'),
        }],
        ['core/spacer', {height: '32px'}],
        ['core/query',
          POSTS_LIST_BLOCK_ATTRIBUTES,
          getPostListBlockTemplate(__('Donate', 'planet4-master-theme')),
        ],
      ]],
    ]],
  ]],
