...
final class ReadingTimeCalculatorTest extends TestCase
{
     ...
     */
    public function testWordCount(string $locale, string $text, int $expected): void
    {
     ...
     */
    public function testReadingTime(string $locale, int $wpm, string $content, int $expected): void
    {
