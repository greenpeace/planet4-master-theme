...
class Post extends TimberPost {
	 ...
	 *
	 * @param $attributes array Block attributes, unused.
	 * @param $content string Content which apparently no core block uses.
	 * @param $block WP_Block With all block properties.
	 *
	...
	public static function reading_time_block( array $attributes, $content, $block ) {
		...
		return "<p style='font-size:12px'>$time min read</p>";
	}
