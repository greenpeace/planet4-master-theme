...
class_alias(\P4\MasterTheme\CustomPostType\PostArchive::class, 'P4_Post_Archive');
class_alias(\P4\MasterTheme\CustomPostType\PostCampaign::class, 'P4_Post_Campaign');
