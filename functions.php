...
//		add_action( 'pre_get_posts',            array( $this, 'tags_support_query' ) );
	...
	public function enqueue_public_assets() {
		...
		wp_enqueue_style( 'parent-style', $this->theme_dir . '/src/css/style.css', [], '0.0.50' );
		...
		wp_enqueue_script( 'custom', $this->theme_dir . '/assets/js/custom.js', array( 'jquery' ), '0.1.10', true );
