...
class P4_Post_Campaign {
	...
	private function hooks() {
		...
		add_action(
			'cmb2_render_footer_icon_link',
			[ $this, 'cmb2_render_footer_icon_link_field_callback' ],
			10,
			5
		);
	...
	public function cmb2_render_footer_icon_link_field_callback(
		...
		?>
													 href="https://github.com/greenpeace/planet4-styleguide/tree/master/src/icons">
			<?php
					esc_html_e(
	...
	public static function get_passive_button_color( array $css_vars, array $meta ): array {
		...
		$css_vars['passive_button_color'] = isset( $meta['campaign_primary_color'] ) && $meta['campaign_primary_color']
				? $passive_button_colors_map[ strtolower( $meta['campaign_primary_color'] ) ] : '#f36d3a';
	...
	public static function get_footer_theme( array $css_vars ): array {
		$footer_theme = ! empty( $css_vars['campaign_footer_theme'] ) ? $css_vars['campaign_footer_theme'] : null;

		$default_footer_links_color = $css_vars['campaign_nav_color'] ? $css_vars['campaign_nav_color'] : '#1A1A1A';

		if ( 'white' === $footer_theme ) {
			$css_vars['footer_links_color'] = $css_vars['footer_links_color'] ? $css_vars['footer_links_color']
