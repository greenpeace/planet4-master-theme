            ...
            register_rest_route(
                ...
                [
                    ...
                    'callback' => function () {
                        ...
                        return [
                            'post_types' => $to_options( get_terms( [ 'taxonomy' => 'p4-page-type', 'hide_empty' => true ] ) ),
                            'categories' => $to_options( get_terms( [ 'taxonomy' => 'category', 'hide_empty' => true ] ) ),
                            'tags'       => $to_options( get_terms( [ 'taxonomy' => 'post_tag', 'hide_empty' => true ] ) ),
                        ];
                    },
                ]
            );
