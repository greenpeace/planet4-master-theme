...
if ( ! defined( 'P4ML_PUBLIC_DIR' ) ) {
	define( 'P4ML_PUBLIC_DIR', plugins_url( P4ML_PLUGIN_DIRNAME . '/public/' ) );
}
if ( ! defined( 'P4ML_LANGUAGES' ) ) {
	define( 'P4ML_LANGUAGES', [
		'en_US' => 'English',
		'el_GR' => 'Ελληνικά',
	] );
}
...
require_once __DIR__ . '/classes/class-p4en-loader.php';


/* ==========================
      L O A D  P L U G I N
   ========================== */
P4ML\P4ML_Loader::get_instance( [
	'P4ML\Controllers\Menu\P4ML_Search_Controller',
	'P4ML\Controllers\Menu\P4ML_Settings_Controller',
//	'P4ML\Controllers\P4ML_Media_library_api_Controller'
], 'P4ML\Views\P4ML_View' );
