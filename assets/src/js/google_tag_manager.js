...
if (typeof googleTagManagerData !== 'undefined') {
  console.log('Option Value:', googleTagManagerData);
  ...
  const enable_google_consent_mode = googleTagManagerData.enable_google_consent_mode;
  ...
  const cf_campaign_name = '{% if cf_campaign_name is defined and cf_campaign_name is not null %}{{ cf_campaign_name|raw }}{% endif %}';
  const cf_project_id = '{% if cf_project_id is defined and cf_project_id is not null %}{{ cf_project_id|raw }}{% endif %}';
  const cf_local_project = '{% if cf_local_project is defined and cf_local_project is not null %}{{ cf_local_project|raw }}{% endif %}';
  const cf_basket_name = '{% if cf_basket_name is defined and cf_basket_name is not null %}{{ cf_basket_name|raw }}{% endif %}';
  const cf_scope = '{% if cf_scope is defined and cf_scope is not null %}{{ cf_scope|raw }}{% endif %}';
  const cf_department = '{% if cf_department is defined and cf_department is not null %}{{ cf_department|raw }}{% endif %}';
  ...
  const gtm_allow = '{{ enforce_cookies_policy }}' ? cookie_consent : true;
