...
const template = () => ([
  ['core/group', {className: 'block'}, [
    ...
    ['planet4-block-templates/deep-dive', {
      title: __('Better understand the issues [deep dive topics]', 'planet4-master-theme'),
      backgroundColor: 'white',
    }],
    ['planet4-block-templates/side-image-with-text-and-cta', {
      title: __('What we do', 'planet4-master-theme'),
      mediaPosition: 'right',
      alignFull: true,
    }],
    ['planet4-block-templates/highlighted-cta', {
      titlePlaceholder: __('Featured action title', 'planet4-master-theme'),
    }],
    ['core/query',
    ...
    ['core/query',
      ACTIONS_LIST_BLOCK_ATTRIBUTES,
      getActionsListBlockTemplate(__('Latest investigations', 'planet4-master-theme')),
    ],
    gravityFormWithText(),
